                  ...
                  <div className="text-gray-600">
                    <div class="mx-10 mt-18   w-60 text-center ">
                      <div class="relative  w-50 img-responsive">
                        <img
                          class="  object-scale-down object-fill rounded-full absolute"
                          src="https://images.pexels.com/photos/2690323/pexels-photo-2690323.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                          alt=""
                        />
                        <div class=" group hover:bg-gray-200 opacity-60 rounded-full absolute flex justify-center items-center cursor-pointer transition duration-500"></div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="mt-4 space-y-4">
                          <div className="flex items-start">
                            <label class="relative inline-flex items-center cursor-pointer">
                              ...
                              <span class="ml-3 text-large font-sm text-gray-900 dark:text-gray-800">
                                {" "}
                                Event Notification
                              </span>
                            </label>
